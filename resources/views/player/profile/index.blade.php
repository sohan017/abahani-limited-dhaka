		...
		<div class="col-md-3">
			...
			<div class="box box-primary">
				<div class="box-body box-profile">
					...
					<img class="profile-user-img img-responsive img-circle" src="{{ $profile->img ? asset($profile->img) : asset('admin/dist/img/user4-128x128.jpg')}}" alt="Player profile picture">
			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content">
					...
					<div class=" tab-pane" id="profile">
						<form class="form-horizontal" action="{{ route('player.profile.update') }}" method="post" enctype="multipart/form-data" >
							@csrf
							...
							<div class="form-group">
								<label for="jersy_no" class="col-sm-2 control-label">Jersy no:</label>

								<div class="col-sm-10">
									<input type="text" class="form-control" id="jersy_no" name="jersy_no" placeholder="Enter jersy no" value="{{ $profile->jersy_no }}">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="nationality" class="form-control" id="nationality" name="nationality" placeholder="Enter  nationality" value="{{ $profile->nationality }}">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="team_id" class="col-sm-2 control-label">Team:</label>

								<div class="col-sm-10">
									<select name="team_id" id="team_id" class="form-control">

										@foreach($teams as $team)
										<option @if($team->id == $profile->team_id) selected @endif value="{{ $team->id }}">{{ $team->name }}</option>
										@endforeach
									</select>
								</div>
							</div>
							<div class="form-group">
								<label for="playertype_id" class="col-sm-2 control-label">Player Type:</label>
					...
					<div class="active tab-pane" id="password">
						<form class="form-horizontal" action="{{ route('player.profile.change.password') }}" method="post" >
							@csrf
							<div class="form-group">
