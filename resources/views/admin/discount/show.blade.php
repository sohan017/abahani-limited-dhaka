       ...
       <div class="col-md-6">
         <div class="box">
             <div class="box-header">
                <h3 class="box-title">Discount Profile</h3>
             </div>
             <div class="box-body">
            ...
            <div class="btn-group">
                ...
                <a href="{{ route('admin.discount.edit', $discount->id) }}" class="btn btn-success"><i class="fa fa-edit"> Edit</i></a>
