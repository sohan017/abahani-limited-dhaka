		...
		<div class="col-md-3">
			...
			<div class="box box-primary">
				<div class="box-body box-profile">
					...
					<img class="profile-user-img img-responsive img-circle" src="{{ asset($player->img) }}" alt="Player profile picture">
					...
					<ul class="list-group list-group-unbordered">
						<li class="list-group-item">
							<b>Player Name</b> <a class="pull-right">{{ $player->name }}</a>
						</li>
						<li class="list-group-item">
		...
		<div class="col-md-9">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Physio Note For Player Fitness</h3>
				</div>
				<!-- /.box-header -->
				@include("partial.notification")
				<!-- form start -->
				<form role="form" action="{{route('physio.playerfitnessnote.post', $player->id) }}" method="post" enctype="multipart/form-data">
					@csrf
					<div class="box-body">
